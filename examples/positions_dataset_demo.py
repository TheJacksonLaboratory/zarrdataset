...
try:
    ...
    if __name__ == "__main__":
        ...
        # This Dataset will retrieve patches and the ROI from where them were
        # taken
        ...
        # The Dataset was set to generate batches, so here we set `batch_size`
        # to None. However, we still need to use the collate function from
        # zarrdataset to convert any pairs generated by the Dataset to PyTorch
        # tensors.
